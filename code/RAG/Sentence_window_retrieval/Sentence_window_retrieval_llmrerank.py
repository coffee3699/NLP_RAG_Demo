...
def main(args):
    ...
    # 6.查询
    window_response = sentence_window_engine.query("What did Elon Musk become in 2004?")
    # 7.打印结果
...
if __name__ == '__main__':
    ...
    Settings.rerank_model = RankGPTRerank(top_n=args.rerank_top_n, llm=MyApiLLM(args.api_key, args.secret_key))  # 使用 RankGPTRerank
    main(args)
