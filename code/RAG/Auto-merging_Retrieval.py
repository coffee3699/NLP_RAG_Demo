...
from llama_index.core.node_parser import HierarchicalNodeParser, get_leaf_nodes, SemanticSplitterNodeParser
...
def build_automerging_index(documents, save_dir="merge_index", chunk_sizes=None, buffer_size=1024):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--api_key', type=str, help='api_key', default=os.getenv('API_KEY'))
    parser.add_argument('--secret_key', type=str, help='secret_key', default=os.getenv('SECRET_KEY'))
    ...
    Settings.rerank_model = RankGPTRerank(top_n=args.rerank_top_n, llm=llm, verbose=False)
    main(args)
