"""
Hierarchical Indexing, Auto-Merging Retriever, RankGPT Reranker
"""
import os
...
RESULTS_PATH = 'HI_AM_GPT_results.json'
SIMILARITY_TOP_K = 12
...
if __name__ == '__main__':
    ...
    Settings.rerank_model = RankGPTRerank(top_n=RERANK_TOP_N, llm=llm)
