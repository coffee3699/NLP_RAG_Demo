...
if __name__ == '__main__':
    ...
    parser.add_argument('--embedding_model_path', type=str, help='local embedding model path',
                        default='../BAAI/bge-small-en-v1.5/snapshots/5c38ec7c405ec4b44b94cc5a9bb96e735b38267a')
    ...
    parser.add_argument('--rerank_model_path', type=str, help='local rerank model path',
                        default='../BAAI/bge-reranker-base/snapshots/02affbdf4485dbf4ae0f133ec3ca467884c00b99')
